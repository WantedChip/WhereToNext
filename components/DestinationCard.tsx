...
export default function DestinationCard({
  ...
  return (
    <Link
      ...
      className="block group no-underline focus:outline-none focus:ring-2 focus:ring-brass rounded-xs"
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 pt-3 border-t border-ink-navy/10 flex items-center justify-between">
          ...
          <span
            className="inline-flex items-center gap-1 font-sans font-bold text-xs uppercase tracking-wider text-sea-teal group-hover:text-brass transition-colors rounded px-0.5"
          >
            View Log
